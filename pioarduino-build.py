...
env.Append(
    ...
    LINKFLAGS=[
        ...
        "-T", "esp32p4.rom.eco5.ld",
        "-T", "esp32p4.rom.api.ld",
        "-T", "esp32p4.rom.eco5.rvfp.ld",
        "-T", "esp32p4.rom.wdt.ld",
        "-T", "esp32p4.rom.systimer.ld",
        "-T", "esp32p4.rom.version.ld",
        "-T", "esp32p4.rom.eco5.libc.ld",
        "-T", "esp32p4.rom.eco5.newlib.ld",
        "-T", "memory.ld",
        "-T", "sections.ld",
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "esp_hw_support", "mspi_timing_tuning", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "esp_hw_support", "mspi_timing_tuning", "tuning_scheme_impl", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "esp_hw_support", "power_supply", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "esp_hw_support", "mspi_timing_tuning", "port", "esp32p4"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "soc", "esp32p4", "register", "hw_ver3"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "esp_psram", "xip_impl", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_wifi_remote", "idf_v5.5", "include", "injected"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_wifi_remote", "idf_v5.5", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "esp_driver_spi", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "esp_gdbstub", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "common", "osi", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "common", "api", "include", "api"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "common", "btc", "profile", "esp", "blufi", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "common", "btc", "profile", "esp", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "common", "hci_log", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "common", "ble_log", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "common", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "core"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "core", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "core", "storage"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "btc", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "models", "common", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "models", "client", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "models", "server", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "api", "core", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "api", "models", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "api"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "lib", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "v1.1", "api", "core", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "v1.1", "api", "models", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "v1.1", "btc", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "v1.1", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "v1.1", "dfu"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "esp_ble_mesh", "v1.1", "mbt"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "common", "tinycrypt", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "common", "tinycrypt", "port"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "ans", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "bas", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "dis", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "gap", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "gatt", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "hr", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "htp", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "ias", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "ipss", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "lls", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "prox", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "cts", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "tps", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "hid", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "sps", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "cte", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "util", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "store", "ram", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "store", "config", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "host", "services", "ras", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "porting", "nimble", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "port", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "transport", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "nimble", "transport", "common", "hci_h4", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "porting", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "bt", "host", "nimble", "nimble", "porting", "npl", "freertos", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "esp_driver_bitscrambler", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "esp_driver_twai", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "esp_hal_ieee802154", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__dl_fft"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__dl_fft", "base"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__dl_fft", "base", "isa"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp-sr", "esp-tts", "esp_tts_chinese", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp-sr", "include", "esp32p4_eco5"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp-sr", "src", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_hosted", "host"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_hosted", "host", "api", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_modem", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__esp_modem", "command", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__lan86xx_common", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32p4", "include", "espressif__lan867x", "include"),
    ...
    LIBS=[
        "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_psram", "-lesp_driver_uart", "-lapp_trace", "-lesp_event", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lnvs_flash", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lbt", "-lunity", "-lcmock", "-lconsole", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_ana_cmpr", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_bitscrambler", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-lesp_driver_isp", "-lesp_driver_cam", "-lesp_driver_jpeg", "-lesp_driver_ppa", "-lesp_driver_touch_sens", "-lesp_eth", "-lesp_hid", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lesp_https_server", "-lesp_lcd", "-lprotobuf-c", "-lprotocomm", "-lesp_local_ctrl", "-lespcoredump", "-lwear_levelling", "-lfatfs", "-ljson", "-lmqtt", "-lnvs_sec_provider", "-lrt", "-lspiffs", "-lusb", "-lespressif__esp-nn", "-lespressif__esp-tflite-micro", "-lchmorgan__esp-libhelix-mp3", "-lespressif__esp-modbus", "-lespressif__libsodium", "-lespressif__mdns", "-lespressif__esp-dsp", "-lespressif__dl_fft", "-lespressif__esp-sr", "-lespressif__esp_hosted", "-lespressif__esp_modem", "-lespressif__esp_serial_slave_link", "-lespressif__eppp_link", "-lespressif__esp_wifi_remote", "-lespressif__lan86xx_common", "-lespressif__lan867x", "-lespressif__network_provisioning", "-ljoltwallet__littlefs", "-larduino_tinyusb", "-lfb_gfx", "-lapp_trace", "-lapp_trace", "-lcmock", "-lunity", "-lesp_driver_cam", "-lesp_driver_isp", "-lesp_driver_jpeg", "-lesp_driver_ppa", "-lesp_lcd", "-lesp_local_ctrl", "-lesp_https_server", "-lmqtt", "-lnvs_sec_provider", "-lrt", "-lespressif__esp-tflite-micro", "-lespressif__esp-nn", "-lm", "-lespressif__esp_serial_slave_link", "-lesp_driver_touch_sens", "-lesp_hid", "-lfatfs", "-lwear_levelling", "-lusb", "-lchmorgan__esp-libhelix-mp3", "-lespressif__esp-modbus", "-lespressif__libsodium", "-lespressif__mdns", "-lespressif__esp-sr", "-ldl_lib", "-lc_speech_features", "-lesp_audio_front_end", "-lesp_audio_processor", "-lesp_tts_chinese", "-lvoice_set_xiaole", "-lfst", "-lflite_g2p", "-lhufzip", "-lmultinet", "-lnsnet", "-lvadnet", "-lwakenet", "-lespressif__esp-sr", "-ldl_lib", "-lc_speech_features", "-lesp_audio_front_end", "-lesp_audio_processor", "-lesp_tts_chinese", "-lvoice_set_xiaole", "-lfst", "-lflite_g2p", "-lhufzip", "-lmultinet", "-lnsnet", "-lvadnet", "-lwakenet", "-lspiffs", "-lespressif__esp-dsp", "-lespressif__dl_fft", "-lespressif__esp-dsp", "-lespressif__dl_fft", "-lespressif__esp_modem", "-lespressif__lan867x", "-lespressif__lan86xx_common", "-lesp_eth", "-lespressif__network_provisioning", "-lprotocomm", "-lprotobuf-c", "-ljson", "-ljoltwallet__littlefs", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lnvs_flash", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lbt", "-lconsole", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_ana_cmpr", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_bitscrambler", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lespressif__esp_hosted", "-lespressif__esp_wifi_remote", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lnvs_flash", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lbt", "-lconsole", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_ana_cmpr", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_bitscrambler", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lespressif__esp_hosted", "-lespressif__esp_wifi_remote", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lnvs_flash", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lbt", "-lconsole", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_ana_cmpr", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_bitscrambler", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lespressif__esp_hosted", "-lespressif__esp_wifi_remote", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lnvs_flash", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lbt", "-lconsole", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_ana_cmpr", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_bitscrambler", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lespressif__esp_hosted", "-lespressif__esp_wifi_remote", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lnvs_flash", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lbt", "-lconsole", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_ana_cmpr", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_bitscrambler", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lespressif__esp_hosted", "-lespressif__esp_wifi_remote", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lriscv", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lesp_driver_usb_serial_jtag", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lnvs_flash", "-lesp_wifi", "-lesp_driver_spi", "-lesp_gdbstub", "-lbt", "-lconsole", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_ana_cmpr", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_bitscrambler", "-lesp_driver_rmt", "-lesp_driver_tsens", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_parlio", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lespressif__esp_hosted", "-lespressif__esp_wifi_remote", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lc", "-lm", "-lstdc++", "-lpthread", "-lnewlib", "-lgcc", "-lcxx"
    ],
    ...
    CPPDEFINES=[
        ...
        "ESP_PLATFORM",
        ("IDF_VER", '\\"v5.5.3-245-ga9de5ec5b9\\"'),
